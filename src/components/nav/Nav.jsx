...
function Nav() {
  return (
    <nav className="bg-[#212121] fixed w-full z-20 top-0 start-0  text-purple-400">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border *:text-purple-400 border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
              <a
                href="#"
                className="block py-2 px-3 text-white bg-purple-400 rounded md:bg-transparent md:p-0 md:dark:text-blue-500"
                aria-current="page"
              >
                Home
              </a>
